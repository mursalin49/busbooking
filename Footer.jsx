    ...
    <footer className="w-full lg:px-28 md:px-16 sm:px-7 px-4 py-8 bg-neutral-200/60 dark:bg-neutral-900/70">
      <div className="grid grid-cols-5 gap-5">
        <div className="space-y-5 col-span-2">
          ...
          SNN Luxurious offers premium bus travel across Bangladesh, providing passengers with top-notch comfort and reliability. Our service ensures safe, punctual, and enjoyable rides, connecting major cities with ease. Through our convenient online booking platform, travelers can effortlessly choose their preferred routes, compare fares, and select seats.
          </p>
        </div>
